...
class CylindricalKITTI(Segmentation):
    def __init__(self,
        ...
        self.min_voxel_coords = min_voxel_coords
        self.max_voxel_coords = max_voxel_coords
    ...
    def __getitem__(self, index):
        ...
        point_coords = points_quantized[:, :3].astype(np.uint8)
        ...
        point_features = np.concatenate(
            (points, kitti_points[:, :2], offset_to_center), axis=1)
